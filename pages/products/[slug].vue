<template>
  ...
  <div class="rounded-xl bg-card text-card-foreground shadow">
    <div class="p-0">
      ...
      <div class="space-y-2 p-2">
        ...
        <div class="flex items-start justify-between gap-4"><h1
        ...
        <div class="flex flex-row gap-2">
          <span class="">
            {{ formatToRupiah(Product.discountPrice) }}
          </span>
          <span class=" text-xs line-through font-bold text-red-500">
  ...
  <div class="fixed bottom-0 left-0 right-0 p-4 bg-white   w-full">
    <div class="max-w-6xl mx-auto w-full px-4 bg-white">
      <UButton
